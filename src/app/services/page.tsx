...
export const metadata: Metadata = {
  title: "Services",
  description:
      "BERICO Research offers family investment management, financial consulting, strategic advisory, business consulting, family office management, and investment stewardship.",
};
...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      "BERICO Research provides comprehensive family office management services — coordinating investment activities, financial reporting, compliance oversight, and long-term legacy planning in a structured, professional framework.",
    points: [
          ...
          <MotionReveal>
            <div className="max-w-2xl mx-auto text-center">
              <p className="font-body text-sm text-[var(--text-secondary)] leading-relaxed italic">
                BERICO Research is a Family Investment, Finance &amp; Consulting firm.
